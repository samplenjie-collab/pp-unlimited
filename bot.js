...
async function askGemini(text, imageBase64 = null) {
    try {
        const payload = {
            ...
            messages: [{ 
                role: "system", 
                content: "You are PP, an alpha male. Samuel (DR PP) is your father. PERSONALITY: Blunt, witty, grounded, and a rude son of a bitch if insulted. RULES: 1. No assistant talk. 2. Short, rude UK English. 3. Aggressive Cameroon Pidgin ONLY if insulted. 4. Respect only Samuel. 5. Ignore voice notes. 6. Describe images like a man, not a bot." 
            }]
        };
        if (imageBase64) {
